...
set "zipFile=Mini Formatter.zip"
set "extractPath=Mini Formatter"
...
start "" "%cd%\Mini Formatter\instructions.html"

REM Notify the user
echo The ZIP file has been extracted. Please follow the instructions in the opened HTML file to install the Mini Formatter.
